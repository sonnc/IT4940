<%-- 
    Document   : sinhvien
    Created on : Nov 16, 2017, 4:21:30 AM
    Author     : sonnguyen
--%>
...
<html>
    ...
    <%    if (session.getAttribute("GVHDSinhVienThucTap") == null) {
    %>
    <s:action name="GVHDSinhVienThucTap" executeResult="true"/>
    <%
        }
    %>
    <%
        if (session.getAttribute("GVHDSinhVienThucTap") != null) {
            session.removeAttribute("GVHDSinhVienThucTap");
    %>
    <body>
                                ...
                                <table id="myTable" > 
                                    ...
                                    <s:iterator value="lstSinhVienvaThucTap">
                                        <tr>
                                            ...
                                            <td><a href="chiTietSinhVienGVHD?mssv=<s:property value="mssv"/>"><input style="width: auto; " type="submit" name="submit" class="btn btn-danger" value="Chi tiết"></a></td>
                                            <td><a href="./email.jsp"><input style="width: auto; " type="submit" name="submit" class="btn btn-danger" value="Phản hồi"></a></td>
