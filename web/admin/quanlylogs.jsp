<%-- 
    Document   : quanlylogs
    Created on : Nov 17, 2017, 3:41:37 AM
    Author     : sonnguyen
--%>
...
<html>
    ...
    <body>
        <%    if (session.getAttribute("QuanLyLogs") == null) {
        %>
        <s:action name="QuanLyLogs" executeResult="true"/>
        <%
            }
        %>
        <%
            if (session.getAttribute("QuanLyLogs") != null) {
                session.removeAttribute("QuanLyLogs");
        %>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12" style="margin: 0px ">   
                            ...
                            %>
                            <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Tìm kiếm nhật ký ..." title="Type in a name">
