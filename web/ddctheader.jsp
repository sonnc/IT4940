<%-- 
    Document   : ddctheader
    Created on : Sep 9, 2017, 10:51:25 PM
    Author     : sonnguyen
--%>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li ><a href="home.jsp">Sinh viên</a></li>
                    <li class="dropdown"><a href="#">Công ty<i class="fa fa-angle-down"></i></a>
                        <ul role="menu" class="sub-menu">
                            <li><a href="service.html">Thông tin</a></li>
                            <li><a href="service.html">Cán bộ</a></li>
                        </ul>
                    </li>            
                    <li class="dropdown"><a><img style="height: 20px; width: 20px" src="asset/images/ico/apple-touch-icon-114-precomposed.png"/></a>
                        <ul role="menu" class="sub-menu">
                            ...
                            <li><a href="aboutus.html">Hộp thư</a></li>
