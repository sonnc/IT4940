<%-- 
    ...
    Created on : Nov 15, 2017, 1:14:49 PM
    Author     : sonnguyen
--%>
...
<html>
    ...
    <%        if (session.getAttribute("GVTTGetAllDiemThi") == null) {
    %>
    <s:action name="GVTTGetAllDiemThi" executeResult="true"/>
    <%
        }
    %>
    <%
        if (session.getAttribute("GVTTGetAllDiemThi") != null) {
            session.removeAttribute("GVTTGetAllDiemThi");
    %>
    <body>
            ...
            <div class="vertical-center sun">
                <div class="container">
                    <div class="row">
                        <div class="action">
                            <div class="col-sm-12">
                                <h1 class="title">DANH SÁCH ĐIỂM THI</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <table id="myTable" > 
                                    ...
                                    <s:iterator value="lstSinhVienDiem">
                                        <tr>
                                            ...
                                            <td><s:property value="diemCuoiKy"/></td>
                                        </tr>
                                    </s:iterator>
                                </table>
