...
<html>
    ...
    %>
    <s:action name="getAllCongTyGV" executeResult="true"/>
    <%
        }
    %>
    <%
                            ...
                            <div class="col-md-12">
                                ...
                                <s:iterator value="lstCongTy">
                                    <div class="media">
                                        <div class="row">
                                            <div class="col-md-2">
                                                <a href="#"><img src="<s:property value="avatar"/>" alt="" style="width:100%;height:100%;"></a>
                                            </div>
                                            <div class="col-md-10">
                                                <div class="media-body">
                                                    <blockquote style="margin: 0 0 0px;"><a href="chiTietCongTyGV?maCongTy=<s:property value="msct"/>"><s:property value="tenCongTy"/></a></blockquote>
