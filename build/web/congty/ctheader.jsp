<%-- 
    Document   : ctheader
    Created on : Nov 8, 2017, 2:44:53 AM
    Author     : sonnguyen
--%>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a>Công ty<i class="fa fa-angle-down"></i></a>
                        <ul role="menu" class="sub-menu">
                            <li><a href="congty/congty.jsp">Công ty</a></li>
                            <li><a href="congty/nhanvien.jsp">Nhân viên</a></li>
                            <li><a href="congty/detai.jsp">Đề tài</a></li>
                        </ul>
                    </li>                    
                    ...
                    <s:iterator value="%{#session.lstDaiDienCongTy}">
                        <li class="dropdown"><a><img style="height: 20px; width: 20px" src="<s:property value="avatar"/>"/><i class="fa fa-angle-down"></i></a>
                            <ul role="menu" class="sub-menu">
                                ...
                                <li><a href="/congty/thongtindaidien.jsp">Thông tin cá nhân</a></li>
                                <li><a href="DDCTLogOut" >Đăng xuất</a></li>
                            </ul>
                        </li> 
                    </s:iterator>
