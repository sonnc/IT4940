<%-- 
    Document   : congty
    Created on : Nov 8, 2017, 3:00:08 AM
    Author     : sonnguyen
--%>
...
<html>
    ...
    %>
    <s:action name="CongTyGetCongTy" executeResult="true"/>
    <%
        }
    %>
    <%
                                            ...
                                            <s:iterator value="lstCongTy">
                                                <div class="col-md-4">
                                                    <div class="post-thumb">
                                                        <a href="#"><img style="height: 100%; width: 100%" src="<s:property value="avatar"/>" class="img-responsive" alt=""></a>
                                                        <div class="btn">
