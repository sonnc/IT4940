<%-- 
    Document   : quanlydetai
    Created on : Nov 16, 2017, 11:51:56 PM
    Author     : sonnguyen
--%>
...
<html>
    ...
    <body>
        <%    if (session.getAttribute("QuanLyDeTai") == null) {
        %>
        <s:action name="QuanLyDeTai" executeResult="true"/>
        <%
            }
        %>
        <%
            if (session.getAttribute("QuanLyDeTai") != null) {
                session.removeAttribute("QuanLyDeTai");
        %>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12" style="margin: 0px ">   
                            ...
                            %>
                            <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Tìm kiếm công ty ..." title="Type in a name">
                            ...
                            <table id="myTable" >
                                ...
                                <s:iterator value="lstDeTai">
                                    <tr>
                                        ...
                                        <td><s:property value="maCongTy"/></td>
                                        <td><s:property value="tenDeTai"/></td>
                                        <td><s:property value="soLuong"/></td>
                                        <td><a href="xoaDetai?id=<s:property value="id"/>"><input onclick="return show_comfirm()" style="width: auto; " type="submit" name="submit" class="btn btn-danger" value="XÓA CÔNG TY"></a></td>
