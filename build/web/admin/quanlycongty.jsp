<%-- 
    Document   : quanlycongty
    Created on : Nov 16, 2017, 11:51:48 PM
    Author     : sonnguyen
--%>
...
<html>
    ...
    <body>
        <%    if (session.getAttribute("QuanLyCongTy") == null) {
        %>
        <s:action name="QuanLyCongTy" executeResult="true"/>
        <%
            }
        %>
        <%
            if (session.getAttribute("QuanLyCongTy") != null) {
                session.removeAttribute("QuanLyCongTy");
        %>
                            ...
                            <table id="myTable" >
                                ...
                                <s:iterator value="lstCongTy">
                                    <tr>
                                        ...
                                        <td><a href="xoaCongTy?msct=<s:property value="msct"/>"><input onclick="return show_comfirm()" style="width: auto; " type="submit" name="submit" class="btn btn-danger" value="XÓA CÔNG TY"></a></td>
