<%-- 
    ...
    Created on : Nov 16, 2017, 11:51:12 PM
    Author     : sonnguyen
--%>
...
<html>
    ...
    <body>
        <%    if (session.getAttribute("QuanLySinhVien") == null) {
        %>
        <s:action name="QuanLySinhVien" executeResult="true"/>
        <%
            }
        %>
        <%
            if (session.getAttribute("QuanLySinhVien") != null) {
                session.removeAttribute("QuanLySinhVien");
        %>
                            ...
                            <table id="myTable" >
                                ...
                                <s:iterator value="lstSinhVien">
                                    <tr>
                                        ...
                                        <td><s:property value="vienKhoa"/></td>
                                        <td><s:property value="email"/></td>
                                        <td><s:property value="dienThoai"/></td>
                                        <td><s:property value="ngaySinh"/></td>
                                        <td><s:property value="diaChi"/></td>
                                       <td><a href="xoaSinhVien?mssv=<s:property value="mssv"/>"><input onclick="return show_comfirm()" style="width: auto; " type="submit" name="submit" class="btn btn-danger" value="XÓA TÀI KHOẢN"></a></td>
