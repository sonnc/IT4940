<%-- 
    Document   : diemthi
    Created on : Nov 16, 2017, 4:21:42 AM
    Author     : sonnguyen
--%>
...
<html>
    ...
    %>
    <s:action name="GVHDSinhVienThucTapDiemThi" executeResult="true"/>
    <%
        }
    %>
    <%
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-6">
                                            <a href="./giangvienhuongdan/danhsachdiemthi.jsp"><input type="button" class="btn btn-info" style="float: right; height: 45px" value="DANH SÁCH ĐIỂM"> </a>
                                        </div>
                                    </div>
                                </div>
                                <table id="myTable" > 
                                    ...
                                    <s:iterator value="lstSinhVienvaThucTap">
                                        <form action="ChamDiemSinhVien" method="post">
                                            <tr>
                                                ...
                                                <td><input style="width: 100%" type="submit" class="btn btn-info" value="CHẤM ĐIỂM"></td>                                        </form>
                                        </tr>     
                                        </form>
                                    </s:iterator>
                                </table>
